...
from application.account.serializer import RegisterSerializer, LoginSerializer, ChangePasswordSerializer
...
class RegisterApiView(APIView):
    ...
    def post(self, request):
        ...
        if serializers.is_valid(raise_exception=True):
            serializers.save()
            message = f'Вы успешно зарешистрированы,' \
                      f'Вам отправленно письмо на почту для подверждения'
